...
# if 100 < highway_number < 999 and highway_number % 100 != 00:
#     print(f'I-{highway_number} is auxilary, going', end=' ')
#     primary_highway = highway_number % 100 # write whatever you want here
...
#     print(f'I-{highway_number} is primary, going', end=' ')
#     if highway_number % 2 == 0:
#         print('north/south')
#     else:
#         print('east/west')
